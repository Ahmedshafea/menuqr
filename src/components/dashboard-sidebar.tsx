...
import { BarChart3, Bike, LayoutDashboard, Menu as MenuIcon, Settings, ShoppingBag, Star, Tag, Users } from "lucide-react";
...
export function DashboardSidebar() {
  ...
  const manage = [{href:"/dashboard/drivers",label:workflow("drivers"),icon:Bike},{href:"/dashboard/reviews",label:workflow("reviews"),icon:Star},{href:"/dashboard/team",label:t("team"),icon:Users},{href:"/dashboard/settings",label:t("settings"),icon:Settings}];
